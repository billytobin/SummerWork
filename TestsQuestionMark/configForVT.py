...
for i in java_repos:
    ...
    if not os.path.exists('..\\Repos'):
        os.mkdir()
    pipe = subprocess.Popen(cmd, cwd='..\\Repos')
    pipe.wait()
    cmd = 'java -jar ck-0.6.5-SNAPSHOT-jar-with-dependencies.jar C:\\Users\\willi\\Summer-Work21\\finalRepos\\'+ i.name + ' False 0 False 0 '+ i.html_url + " " + i.get_commits()[0].sha
