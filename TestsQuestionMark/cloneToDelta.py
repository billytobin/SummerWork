...
for repo in project_list:
    ...
    if x_axis and y_axis:
        ...
        plt.savefig('C:\\Users\\willi\\Summer-Work21\\Results\\Graphs\\'+repo+'Delta.png')
        plt.clf()
        ...
        plt.savefig('C:\\Users\\willi\\Summer-Work21\\Results\\Graphs\\'+repo+'Percent.png')
        ...
        plt.title(repo)  # Add a title to the axes.
        #plt.savefig('C:\\Users\\willi\\Summer-Work21\\Results\\Results1.2\\RxJava\\graph.png')
        plt.savefig('C:\\Users\\willi\\Summer-Work21\\Results\\Graphs\\'+repo+'Total.png')